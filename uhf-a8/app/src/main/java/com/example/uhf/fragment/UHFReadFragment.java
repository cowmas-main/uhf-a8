...
public class UHFReadFragment extends KeyDownFragment implements OnClickListener {
    ...
    private void read() {
        ...
        if (!result) {
            ...
            UIHelper.ToastMessage(mContext, R.string.uhf_msg_read_data_succ);
            mContext.playSound();
        }
    }
